  ...
  return (
    <section className="w-full h-screen flex flex-col items-center justify-start bg-black text-white">
      ...
      <div className="flex flex-col items-center justify-center w-full px-8 gap-16">
        ...
        <h3 className="w-full text-2xl text-center">Fullstack JavaScript developer focused on building clean, interactive web experiences with strong attention to design.</h3>
      </div>
    </section>
  );
}
