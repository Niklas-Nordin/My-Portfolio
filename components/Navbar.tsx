...
function Navbar() {
  ...
  return (
    <nav className="relative w-full h-16 text-white bg-black flex items-center justify-between px-4 border-b-5 border-brand-orange">
      ...
      <div className={`flex gap-8 items-center justify-center uppercase text-lg md:text-sm ${isOpen ? "flex-col gap-8 bg-brand-orange w-[50%] items-center py-16 absolute right-0 top-0 z-30" : "hidden"} md:flex md:flex-row`}>
